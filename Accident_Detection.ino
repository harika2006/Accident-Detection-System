...
updateSerial(); 
//Serial.println("Hello"); 
mySerial.println("AT+CMGS=\"+919030246810\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms 

updateSerial(); 
//Serial.println("Hello"); 
mySerial.print("http://maps.google.com/maps?q="); //text content 
...
delay(1000); 
if (abs(x_adc_value - y_adc_value) >= 25)
